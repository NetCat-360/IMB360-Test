...
import { View, Text, TouchableOpacity, TextInput, Modal, StyleSheet, KeyboardAvoidingView, Platform, TouchableWithoutFeedback, Keyboard, ScrollView } from 'react-native';
              ...
              <View style={[
                ...
                >
                  ...
                  <Text style={localStyles.sheetSubtitleText}>
                    ...
                    <Text style={localStyles.boldTargetEmail}>{targetEmail || 'your email'}</Text>
                  </Text>

                  {/* Centered row container for the separated input blocks */}
                    ...
                    {code.map((digit, index) => (
                      <View 
                        ...
                        style={[
                          ...
                          index !== 5 && localStyles.inputBoxSpacingRight // Injects uniform horizontal gap spacing between boxes
                        ]}
                      >
                        <TextInput
                  ...
                  >
                    <Text style={[localStyles.resendTextString, countdown > 0 && localStyles.resendTextDisabled]}>
...
const localStyles = StyleSheet.create({
  ...
  otpInputRowGrid: {
    flexDirection: 'row',
    justifyContent: 'center', // Centers the separated array neatly on screen
    width: '100%',
    marginBottom: verticalScale(28),
  },
  digitInputBoxFrame: {
    width: scale(42), // Calibrated down slightly to let the inner row breathe
    height: scale(44),
  ...
  inputBoxSpacingRight: {
    marginRight: scale(8), // Creates clear, explicit spacing between individual elements
  },
